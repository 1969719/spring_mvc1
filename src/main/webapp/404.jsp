...
<body>
<div id="clock">
    <p class="date">...404 not found...</p><br>
    <p class="date">登录之后才能看到您所提交的信息</p>
    <p class="time">{{ time }}</p>
    <p class="text">{{ date }}</p><br>
    <a href="login.jsp" class="date" style="color: red;text-decoration:none">点击此处跳转到登录页面</a>
</div>
<script>
    var clock = new Vue({
        el: '#clock',
